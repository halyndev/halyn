...
Site: [aap-protocol.dev](https://aap-protocol.dev) · Spec: [github.com/halyndev/aap](https://github.com/halyndev/aap) · License: MIT
...
Site: [nrprotocol.dev](https://nrprotocol.dev) · Spec: [github.com/halyndev/nrprotocol](https://github.com/halyndev/nrprotocol) · License: MIT
...
Protocol specs ([AAP](https://aap-protocol.dev) · [NRP](https://nrprotocol.dev)) are MIT and always will be.
